...
const MenuButton = ({ 
  ...
  <button
    ...
    className={clsx(
      ...
      disabled ? "text-gray-300 dark:text-gray-600 cursor-not-allowed" : "hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-600 dark:text-gray-300",
      isActive && !disabled ? "bg-gray-200 dark:bg-gray-600 text-blue-600 dark:text-blue-400" : ""
    )}
    title={label}
  >
    {Icon && <Icon size={16} />}
...
export const RichTextEditor: React.FC<RichTextEditorProps> = ({ 
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: 'prose prose-sm max-w-none focus:outline-none min-h-[150px] p-3 dark:prose-invert',
      },
    },
    onUpdate: ({ editor }) => {
  ...
  return (
    <div className={clsx("border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden bg-white dark:bg-gray-800 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500", className)}>
      {/* Toolbar */}
      <div className="flex items-center gap-1 border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-2 flex-wrap">
        <MenuButton
        ...
        {/* Font Size Controls */}
        <div className="flex items-center bg-white dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-600 mr-1">
           <MenuButton
